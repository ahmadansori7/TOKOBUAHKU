...
import Inputan.InputProdukKeluar;
 ...
 * @author ASUS
 */
public class ProdukKeluar extends javax.swing.JFrame {

    /**
     * Creates new form ProdukKeluar
     */
    public ProdukKeluar() {
        initComponents();
    ...
    //digunakan untuk menampilkan data dari tabel produk keluar ke jtabel1
     private void barangkeluartabel() {
        DefaultTableModel model = new DefaultTableModel();
        model.addColumn("Id Keluar");
        model.addColumn("Nama Produk");
        model.addColumn("Stok Keluar (KG)");
         model.addColumn("Tanggal");
         model.addColumn("Keterangan");
        
        try {
  
            String sql = "select produk_keluar.id_keluar, produk.nama_produk, produk_keluar.stok_keluar, produk_keluar.tanggal, produk_keluar.keterangan from produk join produk_keluar on produk.kode_produk = produk_keluar.kode_produk group by produk_keluar.id_keluar order by produk_keluar.tanggal desc";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 280, 1420, 670));
        ...
        getContentPane().add(label8, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 20, 140, 50));
        ...
        label9.setText("Logout");
        label9.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                label9MouseClicked(evt);
            }
        });
        getContentPane().add(label9, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 950, 170, 50));
        ...
        setSize(new java.awt.Dimension(1933, 990));
...
//digunakan untuk mengeksport data dari jtable1 ke xls / excel
        ...
        jTable1.setModel(model);
        try{
            WritableWorkbook write = Workbook.createWorkbook(new File("C:\\Users\\ASUS\\Downloads\\export-data-produk-keluar.xls"));
            WritableSheet sheet = write.createSheet("program_cetak_excel",0);
            sheet.addCell(new Label(0,0,"Id Keluar"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdukKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
